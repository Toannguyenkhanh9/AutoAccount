...
import { AppService } from 'src/app/_shared/services/app';
...
export class LayoutComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  isEmbed$ = this.appService.isEmbed$;
  ...
  // content
  appContentContainer?: 'fixed' | 'fluid';
  ...
  updateProps(config: ILayout) {
    ...
    this.appContentContainer = this.layout.getProp(
